...
<section class="my-5">
  <h2 class="h2-responsive font-weight-bold text-center my-5"><MDBIcon fas icon="spa" />&nbsp; Stay Mindful of Your Emotions and Track Trends:</h2>
...
<section class="my-5">
  <h2 class="h2-responsive font-weight-bold text-center my-5"><MDBIcon fas icon="chart-line" />&nbsp;Visual Insights into Your Emotional Landscape:</h2>
...
<section class="my-5">
  <h2 class="h2-responsive font-weight-bold text-center my-5"><MDBIcon fas icon="users" />&nbsp;Connect and Compare: You're Not Alone:</h2>
