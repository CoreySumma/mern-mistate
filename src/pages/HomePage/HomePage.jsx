...
export default function HomePage({ user }) {
  return (
    <>
      ...
      <MDBContainer>
        <section className="header-container my-5">
          <h3 className="h3-responsive font-weight-bold text-center my-5">
            Discover a new path to mindfulness and emotional well-being. Track
            your emotions, understand your trends, and connect with others on a
            similar journey.
          </h3>
        </section>
      </MDBContainer>
      <div className="background-image-container">
        ...
        <section className="section-container my-5">
          ...
          <p className="lead grey-text text-center w-responsive mx-auto mb-5">
            ...
            transforms your emotional data into visual graphs, making it easier
            to comprehend and act upon. It's not just tracking; it's
        ...
        <section className="section-container my-5">
          ...
          <p className="lead grey-text text-center w-responsive mx-auto mb-5">
            ...
            those of other users. Gain insights into how others are feeling and
