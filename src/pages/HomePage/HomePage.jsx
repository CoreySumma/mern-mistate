...
<section class="my-5">
  <h1 class="h2-responsive font-weight-bold text-center my-5">Embrace Your Emotional Journey</h1>
  <p class="lead grey-text text-center w-responsive mx-auto mb-5">Discover a new path to mindfulness and emotional well-being. Track your emotions, understand your trends, and connect with others on a similar journey.</p>
</section>
